          ...
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr>
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{-- {{ $post->name }} --}} Projet moon </td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{-- {{ $post->periode }} --}} 1 mois </td>
                {{-- @endforeach --}}
