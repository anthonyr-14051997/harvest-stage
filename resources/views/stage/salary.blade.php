            ...
            <table class="min-w-full divide-y divide-gray-300">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr>
                  ...
                  <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{-- {{ $salary->value }} --}} 1200 </td>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{-- {{ $salary->name }} --}} Projet moon </td>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{-- {{ $salary->periode }} --}} 1 mois </td>
                  {{-- @endforeach --}}
